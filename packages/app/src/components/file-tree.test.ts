...
beforeAll(async () => {
  ...
  mock.module("@codingsoft/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@codingsoft/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@codingsoft/ui/icon", () => ({ Icon: () => null }))
  mock.module("@codingsoft/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
