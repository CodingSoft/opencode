...
import type { Hooks } from "@codingsoft/plugin"
    ...
    await Instance.provide({
      ...
      async fn() {
        ...
        if (provider === "opencode") {
          prompts.log.info("Create an api key at https://opencode.codingsoft.org/auth")
        }
        ...
        if (["cloudflare", "cloudflare-ai-gateway"].includes(provider)) {
          prompts.log.info(
            "Cloudflare AI Gateway can be configured with CLOUDFLARE_GATEWAY_ID, CLOUDFLARE_ACCOUNT_ID, and CLOUDFLARE_API_TOKEN environment variables. Read more: https://opencode.codingsoft.org/docs/providers/#cloudflare-ai-gateway",
          )
        }
